[**Y1 Helper 0.9.5**](https://github.com/team-slide/Y1-helper/releases/tag/0.9.5) **is now here for Intel/AMD Windows PCs with improved manual updating, a number of performance improvements, better handling of firmware and app downloads as well as the ability to revert to older versions if needed.**
